...
class HeroTest {
    @DisplayName("Test for heroId if it passes the test")
    @Test
    void getHeroId() {
    ...
    @DisplayName("Test for Hero's name if it passes the test")
    @Test
    void getHeroName() {
        Hero myHero = new Hero(1, "ShanLee", 20, "Indomitable", "Loses Power", "Gigantic", false);
    ...
    @DisplayName("Test for Hero's Age if it passes the test")
    @Test
    void getAge() {
        Hero myHero = new Hero(1, "ShanLee", 20, "Indomitable", "Loses Power", "Gigantic", false);
        Integer expected = 20;
   ...
   @DisplayName("Test for Hero's Special Power if it passes the test")
    @Test
    ...
    @DisplayName("Test for Hero's weakness if it passes the test")
    @Test
    void getWeakness() {
        Hero myHero = new Hero(1, "ShanLee", 20, "Indomitable", "Loses Power", "Gigantic", false);
    ...
    @DisplayName("Test for Squad if  it passes the test")
    @Test
    void getSquad() {
        Hero myHero = new Hero(1, "ShanLee", 20, "Indomitable", "Loses Power", "Gigantic", false);
    ...
    @DisplayName("Test for Deleted if it passes the test")
    @Test
    void getDeleted() {
        Hero myHero = new Hero(1, "ShanLee", 20, "Indomitable", "Loses Power", "Gigantic", false);
